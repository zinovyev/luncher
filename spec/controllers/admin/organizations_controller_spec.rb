  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_organization" do
        organization = Admin::Organization.create! valid_attributes
        put :update, params: {id: organization.to_param, admin_organization: new_attributes}, session: valid_session
        organization.reload
      ...
      it "assigns the requested admin_organization as @admin_organization" do
        organization = Admin::Organization.create! valid_attributes
        put :update, params: {id: organization.to_param, admin_organization: valid_attributes}, session: valid_session
        expect(assigns(:admin_organization)).to eq(organization)
      end
    ...
    context "with invalid params" do
      it "assigns the admin_organization as @admin_organization" do
        organization = Admin::Organization.create! valid_attributes
        put :update, params: {id: organization.to_param, admin_organization: invalid_attributes}, session: valid_session
        expect(assigns(:admin_organization)).to eq(organization)
      end
